...
#define STRING_CONFIG_H_AUTHOR "Michael Bednarek (TronxyP802)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "TronXY P802"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100.4, 100.2, 399, 393.1 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 350, 350, 20, 50 }
